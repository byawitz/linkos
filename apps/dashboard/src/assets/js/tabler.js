...
(function (factory) {
            ...
            Array.prototype.forEach.call(t.length ? t : [t], function (t) {
              return (function (t) {
                if (t && t.nodeName && 'TEXTAREA' === t.nodeName && !e.has(t)) {
                  var o,
                    ...
                    i =
                      ((o = t.value),
                      function () {
                        a({ testForHeightReduction: '' === o || !t.value.startsWith(o), restoreTextAlign: null }), (o = t.value);
                      }),
                    l = function (o) {
                ...
                function a(e) {
                  ...
                  if (
                    0 !== t.scrollHeight &&
                    ('vertical' === n.resize ? (t.style.resize = 'none') : 'both' === n.resize && (t.style.resize = 'horizontal'),
                    u &&
                      ((o = (function (e) {
                        for (var t = []; e && e.parentNode && e.parentNode instanceof Element; )
                          e.parentNode.scrollTop && t.push([e.parentNode, e.parentNode.scrollTop]), (e = e.parentNode);
                        return function () {
                    ...
                    (i =
                      'content-box' === n.boxSizing
                        ? t.scrollHeight - (parseFloat(n.paddingTop) + parseFloat(n.paddingBottom))
                        : t.scrollHeight + parseFloat(n.borderTopWidth) + parseFloat(n.borderBottomWidth)),
                    'none' !== n.maxHeight && i > parseFloat(n.maxHeight)
                      ? ('hidden' === n.overflowY && (t.style.overflow = 'scroll'), (i = parseFloat(n.maxHeight)))
                      : 'hidden' !== n.overflowY && (t.style.overflow = 'hidden'),
                    (t.style.height = i + 'px'),
                    s && (t.style.textAlign = s),
                    o && o(),
                    r !== i && (t.dispatchEvent(new Event('autosize:resized', { bubbles: !0 })), (r = i)),
                    c !== n.overflow && !s)
                  ) {
                    var v = n.textAlign;
                    'hidden' === n.overflow && (t.style.textAlign = 'start' === v ? 'end' : 'start'),
  ...
  class PatternInputDefinition {
    constructor(opts) {
      const { parent, isOptional, placeholderChar, displayChar, lazy, eager } = opts,
  ...
  class ChunksTailDetails {
    ...
    extend(tailChunk) {
      ...
      const extendLast =
        lastChunk && (lastChunk.stop === tailChunk.stop || tailChunk.stop == null) && tailChunk.from === lastChunk.from + lastChunk.toString().length;
  ...
  class PatternCursor {
    ...
    _pushLeft(fn) {
      ...
      for (
        this.bindBlock();
        0 <= this.index;
        --this.index, this.offset = ((_this$block = this.block) === null || _this$block === void 0 ? void 0 : _this$block.value.length) || 0
      ) {
        var _this$block;
  ...
  class MaskedPattern extends Masked {
    ...
    _rebuildMask() {
      ...
      for (let i = 0; i < pattern.length; ++i) {
        ...
        const maskOpts =
          ...
          _defs$char !== void 0 &&
          _defs$char.mask &&
          !(((_defs$char2 = defs[char]) === null || _defs$char2 === void 0 ? void 0 : _defs$char2.mask.prototype) instanceof IMask.Masked)
            ? defs[char]
            : {
                mask: defs[char]
              };
    ...
    _appendEager() {
      ...
      const details = new ChangeDetails();
      let startBlockIndex =
        (_this$_mapPosToBlock = this._mapPosToBlock(this.value.length)) === null || _this$_mapPosToBlock === void 0
          ? void 0
    ...
    _appendCharRaw(ch) {
      ...
      for (let bi = blockIter.index; ; ++bi) {
        ...
        const blockDetails = block._appendChar(
          ...
          Object.assign({}, flags, {
            _beforeTailState:
              (_flags$_beforeTailSta = flags._beforeTailState) === null || _flags$_beforeTailSta === void 0
                ? void 0
                : (_flags$_beforeTailSta2 = _flags$_beforeTailSta._blocks) === null || _flags$_beforeTailSta2 === void 0
                  ? void 0
  ...
  class MaskedDate extends MaskedPattern {
    ...
    doValidate() {
      ...
      return (
        ...
        (!this.isComplete ||
          (this.isDateExist(this.value) && date != null && (this.min == null || this.min <= date) && (this.max == null || date <= this.max)))
      );
    }
    isDateExist(str) {
  ...
  class HTMLMaskElement extends MaskElement {
    ...
    get rootElement() {
      ...
      return (_this$input$getRootNo =
        (_this$input$getRootNo2 = (_this$input = this.input).getRootNode) === null || _this$input$getRootNo2 === void 0
          ? void 0
          : _this$input$getRootNo2.call(_this$input)) !== null && _this$input$getRootNo !== void 0
  ...
  class MaskedNumber extends Masked {
    ...
    doPrepare(ch) {
      ...
      ch = this._removeThousandsSeparators(
        this.scale && this.mapToRadix.length && ((flags.input && flags.raw) || (!flags.input && !flags.raw))
    ...
    doSkipInvalid(ch) {
      ...
      const dropFractional =
        ...
        (ch === this.radix || ch === MaskedNumber.UNMASKED_RADIX || this.mapToRadix.includes(ch));
    ...
    typedValueEquals(value) {
      return (
        (super.typedValueEquals(value) || (MaskedNumber.EMPTY_VALUES.includes(value) && MaskedNumber.EMPTY_VALUES.includes(this.typedValue))) &&
        !(value === 0 && this.value === '')
      );
    }
  }
  ...
  class MaskedDynamic extends Masked {
      ...
      return Object.assign({}, flags, {
        _beforeTailState:
          (((_flags$_beforeTailSta = flags._beforeTailState) === null || _flags$_beforeTailSta === void 0
            ...
            ((_flags$_beforeTailSta2 = flags._beforeTailState) === null || _flags$_beforeTailSta2 === void 0
              ? void 0
    ...
    typedValueEquals(value) {
      ...
      return Boolean(
        (_this$currentMask5 = this.currentMask) === null || _this$currentMask5 === void 0 ? void 0 : _this$currentMask5.typedValueEquals(value)
      );
    }
  }
  ...
  function detectOverflow(state, options) {
    ...
    var clippingClientRect = getClippingRect(
      isElement$1(element) ? element : element.contextElement || getDocumentElement(state.elements.popper),
      boundary,
      rootBoundary,
      strategy
    );
  ...
  function preventOverflow(_ref) {
    ...
    if (checkMainAxis) {
      ...
      var offsetModifierValue =
        (_offsetModifierState$ = offsetModifierState == null ? void 0 : offsetModifierState[mainAxis]) != null ? _offsetModifierState$ : 0;
    ...
    if (checkAltAxis) {
      ...
      var _offsetModifierValue =
        (_offsetModifierState$2 = offsetModifierState == null ? void 0 : offsetModifierState[altAxis]) != null ? _offsetModifierState$2 : 0;
  ...
  tooltipTriggerList.map(function (tooltipTriggerEl) {
    ...
    var options = {
      ...
      placement:
        (_tooltipTriggerEl$get = tooltipTriggerEl.getAttribute('data-bs-placement')) !== null && _tooltipTriggerEl$get !== void 0
          ? _tooltipTriggerEl$get
          : 'auto'
    };
  ...
  popoverTriggerList.map(function (popoverTriggerEl) {
    ...
    var options = {
      ...
      placement:
        (_popoverTriggerEl$get = popoverTriggerEl.getAttribute('data-bs-placement')) !== null && _popoverTriggerEl$get !== void 0
          ? _popoverTriggerEl$get
          : 'auto'
    };
  ...
  var hexToRgba = function hexToRgba(hex, opacity) {
    ...
    return result
      ? 'rgba('.concat(parseInt(result[1], 16), ', ').concat(parseInt(result[2], 16), ', ').concat(parseInt(result[3], 16), ', ').concat(opacity, ')')
      : null;
  };
